...
VALUES	('HOSCH_FDR_PLAYER_AT_PEACE_AND_UNIT_IS_BUILDER',		'REQUIREMENTSET_TEST_ALL');
...
VALUES	('TRAIT_HOSCH_FDR_BUILDERS_PRODUCTION',		'MODIFIER_PLAYER_UNITS_ADJUST_UNIT_PRODUCTION',		0,			'HOSCH_FDR_PLAYER_AT_PEACE_AND_UNIT_IS_BUILDER'),
		('TRAIT_HOSCH_FDR_BUILDERS_EXTRA_CHARGE',	'MODIFIER_PLAYER_UNITS_ADJUST_BUILDER_CHARGES',		0,			'HOSCH_FDR_PLAYER_AT_PEACE_AND_UNIT_IS_BUILDER');

INSERT INTO ModifierArguments
		(ModifierId,								Name,			Value)
VALUES	('TRAIT_HOSCH_FDR_BUILDERS_PRODUCTION',		'UnitType',		'UNIT_BUILDER'),
		('TRAIT_HOSCH_FDR_BUILDERS_PRODUCTION',		'Amount',		100),
...
-- VALUES	('TRAIT_HOSCH_FDR_BUILDERS_EXTRA_CHARGE',	'Preview',	'LOC_TRAIT_LEADER_HOSCH_LEADER_CCC_DESCRIPTION'),
-- 		('TRAIT_HOSCH_FDR_BUILDERS_PRODUCTION',		'Preview',	'LOC_TRAIT_LEADER_HOSCH_LEADER_CCC_DESCRIPTION');